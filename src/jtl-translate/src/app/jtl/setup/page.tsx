...
export default function SetupPage() {
  ...
  useEffect(() => {
    ...
    pluginBridge?.callMethod<string>('getSessionToken')
  ...
  return (
    <div className="flex flex-col gap-6">
      <CardHeader>
        ...
        <CardDescription>
          Please confirm to connect JTL Translate with JTL Hub.<br/>
      ...
      <CardContent className="flex flex-col gap-4">
        <Button
          ...
          label="Connect with JTL Hub"
          disabled={isSubmitting || isLogoutLoading}
